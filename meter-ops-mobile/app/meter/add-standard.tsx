...
import { Card, Field, PrimaryButton, SecondaryButton, styles as ui } from '@/components/MeterUI';
import { KeyboardAwareScrollViewCompat } from '@/components/KeyboardAwareScrollViewCompat';
import { useToast } from '@/context/ToastContext';

export default function AddStandardMeter() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <KeyboardAwareScrollViewCompat contentContainerStyle={{ padding: 16, paddingTop: 16, paddingBottom: insets.bottom + 32, gap: 16 }}>
        ...
        <PrimaryButton testID="add-submit" label="Save Standard Meter" icon="check" onPress={submit} />
        <SecondaryButton testID="add-cancel" label="Cancel" onPress={() => router.back()} />
...
const styles = StyleSheet.create({
  intro: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14 },
